...
import static ua.external.servlet.handler.Paths.VISITOR_HOME_PAGE_PAGE;

public class VisitorHomePageHandlerPost implements ServletHandler {
    private static final Logger logger = LoggerFactory.getLogger(VisitorHomePageHandlerPost.class);

    private TicketService<TicketDto> ticketService;
    private ExhibitionService<ExhibitionDto> exhibitionService;

    public VisitorHomePageHandlerPost(TicketService<TicketDto> ticketService,
    ...
    public String handle(HttpServletRequest request, HttpServletResponse response) {
        ...
        return "redirect:" + VISITOR_HOME_PAGE_PAGE;
    }
}
