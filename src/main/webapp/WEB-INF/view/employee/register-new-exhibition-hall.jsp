...
<div class="container">
    <div class="row">
        <div class="col-md-offset-3 col-md-6">
            ...
            <c:if test="${requestScope.hallRegistered}">
            ...
            <c:if test="${requestScope.hallNotRegistered}">
                <p class="text-danger" role="alert">
                    <fmt:message key="message.exhibitionHallIsExists"/>
                </p>
            </c:if>

            <form method="post" action="/employee/register-new-exhibition-hall" role="form" class="form-horizontal">
